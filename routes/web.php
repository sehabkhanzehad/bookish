...
Route::group(['prefix' => 'admin','middleware' => 'auth','as'=>'admin.'], function() {
    ...
    Route::put('banners-status/{id}', [BannerController::class,'changeStatus'])->name('banners.status');
    ...
    Route::put('subjects-status/{id}', [SubjectController::class,'changeStatus'])->name('subjects.status');
    Route::put('writers-status/{id}', [WriterController::class,'changeStatus'])->name('writer.status');
    Route::put('publications-status/{id}', [PublicationController::class,'changeStatus'])->name('publications.status');
    Route::put('packages-status/{id}', [PackageController::class,'changeStatus'])->name('packages.status');
...
// Route::post('/update-items', array('as'=> 'update.items', 'uses' => 'ItemController@updateItems'));
    ...
    Route::get('menu-category', [HomePageController::class, 'menuCategory'])->name('menu-category');
    Route::post('store-menu-category', [HomePageController::class, 'storemenuCategory'])->name('store-menu-category');
    Route::delete('destroy-menu-category/{id}', [HomePageController::class, 'destroymenuCategory'])->name('destroy-menu-category');
    ...
    Route::post('update/footer/{id}', [FooterController::class,'updateFooter'])->name('updateFooter');
...
Route::group(['as' => 'front.'], function(){
    Route::controller(FrontHomeController::class)->group(function(){
        ...
        Route::get('pdf/book', 'pdfBook')->name('pdfBook');
    ...
    Route::get('product-download/{orderId}/{productId}', [FrontOrderController::class, 'downloadFile'])->name('downloadFile');
