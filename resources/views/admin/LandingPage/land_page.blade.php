...
<body>
    <div class="main-wrapper">
        <div class="top-div"
            style="background-image: url({{ asset('landing_pages/' . $ln_pg->landing_bg) }}); height: 650px;">
            <div class="container">
                ...
                <div class="text-info-box qa" data-aos="fade-up">
                    <div class="row first_section" style="width: 50%;">
                        <div class="col-md-5 ord_section">
                            <a id="order_btn" class="btn"
                                style="background: orange;
                           font-size: 20px;color: #ffffff;padding: 8px 16px;font-family: 'Hind Siliguri', sans-serif !important;"><i
                                    class="fa fa-shopping-cart"
                                    aria-hidden="true"></i>&nbsp;&nbsp;{{ BanglaText('order') }}</a>
                        </div>
                    ...
                    <div class="ani-btn-box" style="margin-top: 45px;">
                        <div class="inner-padding" data-aos="fade-up">
                            <button id="order_btn" class="btn btn-danger"
                                ...
                                {{ BanglaText('do_order') }} <img width=""
                                    src="{{ asset('frontend/images/hand.png') }}" class="order_btn_img" alt="">
                            </button>
                        </div>
                    </div>
                </div>
    ...
    margin: 0 auto;
    padding: 15px;">
                            <p style="margin-bottom:0px;font-family: 'Hind Siliguri', sans-serif !important;">
                                {{ $ln_pg->call_text }}</p>
                            <a href="tel: {{ $ln_pg->phone }}"
                                style="margin-bottom: 0px;text-decoration: none;color: #fff;">{{ $ln_pg->phone }}</a>
                        </div>
    ...
    color: green;">
                            <p
                                style="border-bottom: 2px dashed green;
                         font-family: 'Hind Siliguri', sans-serif !important;
    padding: 10px;
    font-size: 27px;">
                        ...
                        <div class="ani-btn-box">
                            <div class="inner-padding" data-aos="fade-up">
                                <button id="order_btn" class="btn btn-danger"
                                    style="border: 3px solid #AD7419;font-family: 'Hind Siliguri', sans-serif !important;">
                                    {{ BanglaText('do_order') }} <img width=""
                                        src="{{ asset('frontend/images/hand.png') }}" class="order_btn_img"
                                        alt="">
                                </button>
                            </div>
                        </div>
                ...
                <div class="element-widget-cover">
                    <div class="element-widget-wrap">
                        <div class="element-widget feature-list"
                            style="background: #ffffff;text-align: left;padding-left: 0px;">
                                ...
                                @foreach ($ln_pg->review_images as $review_slider)
                                    <div class="col-md-6 col-6 review_slider">
                                        <img src="{{ asset('review_landing_sliders/' . $review_slider->review_image) }}"
                                            style="margin-bottom: 25px;height: 235px;" alt="img">
                                    </div>
                                @endforeach
                            </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="billing-fields">
                                                    <div class="form-group">
                                                        ...
                                                        @if (isset($ln_pg->product))
                                                            <input type="hidden" value="{{ $ln_pg->product->id }}"
                                                    ...
                                                    @endif
                                                    <input type="hidden" id="total_price_val" name="total_amount"
                                                        value="">
                                                    ...
                                                    @if (isset($ln_pg->product))
                                                        <input type="hidden" id="product_name"
                                                            value="{{ $ln_pg->product->name }}" name="product_name">
                                                    @endif
                                                    <div class="form-group">
                                                        <label for="">
                                                            {{ BanglaText('address') }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="order-col" style="width: 100%;">
                                            <h3 style="font-family: 'Hind Siliguri', sans-serif !important;">Your Order
                                            </h3>
