        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('Subject')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.subjects.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Is Menu')}}</th>
                                    <th>{{__('Is Popular')}}</th>
                                    <th>{{__('Is Home Section')}}</th>
                                    <th>{{__('admin.Status')}}</th>
                                    <th>{{__('admin.Action')}}</th>
                                  </tr>
                            </thead>
                            <tbody>
                                @foreach ($subjects as $index => $publication)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        ...
                                        <td>
                                        <a href="{{ route('admin.subjects.edit',$publication->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
