    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if (auth()->user()->can('admin.pc-builder') ||
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('admin.subjects.*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.subjects.index') }}">{{ __('All Subjects') }}</a>
                        </li>
                        ...
                        <li class="{{ Route::is('admin.featured-category') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.featured-category') }}">{{ __('Featured Category') }}</a>
                        </li>
                        <li class="{{ Route::is('admin.menu-category') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.menu-category') }}">{{ __('Menu Category') }}</a>
                        </li>
            ...
            @if (auth()->user()->can('admin.product') ||
                    auth()->user()->can('writer.index') ||
                    auth()->user()->can('publication.index') ||
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('admin.writers.index') }}">
                                ...
                                <span style="color:black">Writers</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ route('admin.publications.index') }}">

                                <span style="color:black">Publications</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ route('admin.packages.index') }}">

                                <span style="color:black">Packages</span></a>
                        </li>
                        <li>
            ...
            @if (auth()->user()->can('homepage.banner') ||
                ...
                <li
                    class="nav-item dropdown {{ Route::is('admin.banners.index') || Route::is('admin.currency.*') || Route::is('admin.shipping.*') || Route::is('admin.coupon.*') || Route::is('admin.payment-method') || Route::is('admin.flash-sale-product') ? 'active' : '' }}">
                    <p class="s-divide">{{ __('Home Page') }}</p>
                    <a href="#" class="nav-link has-dropdown">
                        <div class="icon">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('admin.banners.index') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.banners.index') }}">{{ __('Banners') }}</a></li>
