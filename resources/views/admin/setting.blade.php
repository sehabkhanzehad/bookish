                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="home-setting-tab" data-toggle="tab" href="#homeSettingTab" role="tab" aria-controls="homeSettingTab" aria-selected="true">Home Section Setting</a>
                                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4 catelog" style="">
                                    <label>Upload Catelog</label>
                                    <input type="file" id="catelog" class="form-control"  name="catelog" value="">
                                </div>
                                
                                <div class="form-group col-4 catelog" style="">
                                    <label>Upload Apps</label>
                                    <input type="file" id="apk" class="form-control"  name="apk" value="">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea row="5" class="form-control" name="footer_des">
                                        {{ $footer->footer_des }}
                                    </textarea>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                            ...
                                            <div class="tab-pane fade show" id="homeSettingTab" role="tabpanel" aria-labelledby="home-setting-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.updateFooter', $footer->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                           
                                                            <div class="form-group">
                                                                <label for="">Show E-book</label>
                                                                <div>
                                                                    @if ($footer->show_ebook == 1)
                                                                    <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="show_ebook">
                                                                    @else
                                                                    <input id="status_toggle" type="checkbox" data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="show_ebook">
                                                                    @endif
                                                                </div>
                                                        </div>
