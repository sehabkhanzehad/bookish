    ...
    <div class="container m-fixed-bar d-lg-none d-md-block d-block">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-1 pe-3">
            <button class="btn d-lg-none d-block toggler"><svg class="ct-icon" width="18" height="14"
                    viewBox="0 0 18 14" aria-hidden="true" data-type="type-2">
            ...
            <div class="col-7 d-flex border m-fixed-form">
                ...
                <input type="text" name="search" id="" class="form-control" form="search_form2"
                    placeholder="" aria-describedby="helpId">
            </div>
            <div class="h-cart">
                <a href="{{ route('front.cart.index') }}" class="text-dark h-cart"><img
                        src="{{ asset('assets/images/svg/cart.svg') }}" alt="" width="35"><span
                        class="badge bg-primary rounded-circle">{{ count($cart) }}</span></a>
            </div>
        </div>
    </div>
    <header class="bg-white">
                ...
                <div class="container pt-4 top_section">
                    <div class="d-flex justify-content-between navbar-flex ">
                            ...
                            <form action="{{ route('front.shop') }}" id="search_form">
                                <div class="input-group justify-content-md-center">
                                    <input type="text" value="{{ request('search') }}" name="search"
                                        class="form-control col-12" placeholder="বইয়ের নাম ও লেখক দিয়ে অনুসন্ধান করুন"
                                        aria-label="Input group example" aria-describedby="btnGroupAddon">
                                    <div class="input-group-prepend">
                                        <button class="input-group-text btn btn-warning text-light"
                                            id="btnGroupAddon"><i class="fa fa-search"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div
                            ...
                            <a href="{{ route('front.cart.index') }}" class="text-dark h-cart"><img
                                    src="{{ asset('assets/images/svg/cart.svg') }}" alt="" width="30"><span
                                    class="badge bg-primary rounded-circle">{{ count($cart) }}</span></a>
                        </div>
                        ...
                        <div
                            class="col-lg-3 col-md-3 col-5 d-lg-flex d-none justify-content-end me-lg-3 me-0 user_section">
                            <ul
                                class="navbar navbar_social d-flex submenu justify-content-lg-start label-1 pb-0 mb-0 pt-0">
                                @php $sLinks =DB::table('footer_social_links')->get(); @endphp
                                @foreach ($sLinks as $link)
                                    <li>
                                        <a href="{{ $link->link }}" class="text-light mb-2 me-3"><i
                                                class="{{ $link->icon }}" style="color: red;"></i></a>
                                    </li>
                                @endforeach
                        ...
                        <button class="btn d-lg-none d-block toggler">
                            <svg class="ct-icon" width="18" height="14" viewBox="0 0 18 14"
                                aria-hidden="true" data-type="type-2">
                                <rect y="0.00" width="18" height="1.7" rx="1"></rect>
                                <rect y="6.15" width="18" height="1.7" rx="1"></rect>
                                <rect y="12.3" width="18" height="1.7" rx="1"></rect>
                            </svg>
                ...
                <div class="container d-lg-block d-md-none d-none">
                    <div class="row menu-main">
                        <ul class="navbar d-flex submenu justify-content-lg-start label-1 pb-0 mb-0 pt-0 col-lg-9">
                            <li class="nav-item image_logo_menu d-none" style="border: none;"><a
                                    href="{{ route('front.home') }}" class="navbar-brand col-lg-2 flex-sm-fill">
                                    <img src="{{ asset(siteInfo()->logo) }}" alt="Logo" width="110">
                                </a>
                            </li>
                            ...
                            <li class="nav-item"><a href="{{ route('front.best.seller') }}"
                                    class="nav-link {{ request()->routeIs('front.best.seller') ? 'active' : '' }}">বইমেলা
                                    ২০২৪</a>
                            </li>
                    ...
                    <li class="nav-item"><a href="#" class="nav-link">ব্লগ</a>
                        ...
                        <div class="col-lg-3 login_section">
                            ...
                            @else
                                <a class="" href="{{ route('front.profile') }}"
                                    style="color: #000;text-decoration: none;">{{ auth()->user()->name }}</a>
                            @endguest
                            <span>|</span>
                            @guest
        ...
        <div class="cart-tab">
            <a href="" title="View your shopping cart" class="cart_parent text-center">
                <i class="fa fa-shopping-cart"></i><br><span
                    class="woocommerce-Price-amount amount">{{ $price }}&nbsp;<span
                        class="woocommerce-Price-currencySymbol">৳</span></span>
            </a>
        </div>
        <div class="cart_sidebar">
            <div class="d-flex bg-danger justify-content-between align-items-center px-3">
                <a href="#" class="text-light text-decoration-none"><i
                        class="fas fa-shopping-cart mx-3"></i>Cart</a>
                            ...
                            <div class="product_item mb-3">
                                <div class="d-flex align-item-center justify-content-between">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="mb-1">{{ $item['quantity'] }} × <span
                                                class="text-danger">{{ $item['price'] }} ৳</span></p>
                                    </div>
                                    <div class="remove">
                                        <button class="remove-item btn border-0 d-block p-0 mt-3"
                                            data-id="{{ $key }}">
                        ...
                        <div class="price-box">
                            ...
                            <div class="d-flex justify-content-around gap-3 mb-3">
                                <a href="{{ route('front.cart.index') }}"
                                    class="btn btn-outline-danger border border-muted rounded-0 font-14">
                                    শপিং ব্যাগ
                                </a>
