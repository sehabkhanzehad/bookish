...
.profile-card__img {
  ...
  position: relative;
  z-index: 4;
  box-shadow: 0px 0px 0px 7px #FF6E0A;
}
...
<div class="container">
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="{{ asset('frontend/images/avatar2.png') }}" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">{{ $user->name }}</div>
      <div class="profile-card__txt"><strong>{{ $user->phone }}</strong></div> 
      ...
      <div class="profile-card-inf">
        ...
        <a href="{{ url('order') }}" style="color: #000;">        
          <div class="profile-card-inf__title">{{ $all_order_count }}</div>
          <div class="profile-card-inf__txt">All Orders</div>
        </a>  
        </div>

        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">{{ $all_process_count }}</div>
          <div class="profile-card-inf__txt">Processing Orders</div>
        </div>
        
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">{{ $all_return_count }}</div>
          <div class="profile-card-inf__txt">Returned Orders</div>
        </div>

        <div class="profile-card-inf__item">
        <a href="{{ route('front.pdfBook') }}" style="color: #000;">    
          <div class="profile-card-inf__title">{{ (!empty($productArray)) ? count($productArray) : '0' }}</div>
          <div class="profile-card-inf__txt">BookShelf</div>
        </a>  
        </div>
  ...
  <defs>
    ...
    <section>
            <div class="container mt-3">
                <div class="slider-box">
                    <div class="card p-4">
                        <h6 class="text-danger mb-0">আপনার কেনা বইসমূহ</h6>
                    </div>
    ...
    <section>
            <div class="container mt-3">
                <div class="slider-box">
                    <div class="card p-4">
                        <h6 class="text-danger mb-0">ফ্রি বইসমূহ</h6>
                    </div>
                    <div class="product-sliders row">
                            @foreach($freeproductArray as $key => $product)
                                <div class="product px-3 py-3 text-center col-lg-2">
                                    <a href="{{ route('front.product.show', [ $product->id ] ) }}" title="{{ $product->name }}" class="text-decoration-none">
                                        @if(!empty($product->offer_price))
                                        @php
                                            $discount = (($product->price - $product->offer_price) / $product->price) * 100;
