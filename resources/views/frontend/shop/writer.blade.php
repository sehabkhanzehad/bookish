...
<style>
    ...
    <section>
        <div class="container">
            <h2 class="bold my-3">All Writer</h2>
            ...
            <div class="shop row subjects mt-4">
                @forelse ($writers as $item)
                    <div class="col-lg-3 col-12 item">
                        <a href="{{ route('front.shop') }}?writer={{ $item->id }}" class="text-decoration-none font-16 bold-7 text-muted">
                            <h4>{{ $item->name }}</h4>
                        </a>
                    </div>
                @empty
                <div class="col-lg-3 col-12 item">
                    <h4 class="text-center text-danger bold-7">There Are No Writer</h4>
                </div>
                @endforelse
            </div>
        </div>
