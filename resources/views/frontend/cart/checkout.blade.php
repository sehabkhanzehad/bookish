                    ...
                    <div class="row flex-lg-row-reverse">
                                                ...
                                                <tr>
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="login_text" style="font-size: 14px;">
                                                                {{ BanglaText('login_account') }} <a
                                                                    style="font-size: 11px;background: #20a5fd;color: #ffffff;"
                                                    ...
                                                    <td>
                                                        <div id="coupon-toggle"
                                                            style="font-size: 12px;background: #20a5fd;color: #ffffff;"
                        ...
                        <div id="data_info" class="col-lg-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('front.checkout.store') }}" method="POST" id="checkoutForm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-12 mb-3 form-floating">
                                                <input type="tel" maxlength="11" minlength="11"
                                                    class="form-control shadow-none" name="order_phone"
                           ...
                           ?>
                                            ...
                                            <input type="hidden" name="shipCharge" id="shipCharge">
                                        ...
                                        @endif
                                        <button type="submit" class="btn bg-blue text-light"
                                            style="font-family: 'Kalpurush', sans-serif;width: 100%;height: 50px;font-size: 20px;background: #20a5fd !important;">{{ BanglaText('confirm_order') }}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function getCharge() {
            ...
            $('input[name="cart_total_amount"]').val(total);
