...
@section('content')
    ...
    <div class="container mt-3">
        ...
        <div class="mt-4 p-5 bg-success text-white rounded text-center"
            style="margin-bottom: 5%; box-shadow: 10px 10px 5px gray;">
            ...
            @if (!empty($order_inv->order_phone))
                <a class="btn bg-dark" href="{{ route('front.order-list', $order_inv->order_phone) }}" style="color:white">
                    See
                    all Orders </a>
                ...
                if($orderProduct->product->product_type=='3'){
                    ?>
                            <td>
                                ...
                                <button style="width: 33%;padding: 5px !important;"
    ...
    @foreach ($order_inv->orderProducts as $orderProduct)
        <div class="modal fade" id="read_more_{{ $orderProduct->product->id }}" tabindex="-1"
