...
<div class="container">
    ...
    <div class="col-md-2">
       @if(auth()->check()) 
       <a class="btn btn-warning" href="{{ route('front.pdfBook') }}" style="margin-top: 4px;">Go To Library</a>
       @else
       <a class="btn btn-warning" href="{{url('login-user')}}" style="margin-top: 4px;">Go To Library</a>
       @endif
    </div>
</div>
