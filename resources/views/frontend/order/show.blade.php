        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                @forelse($order->orderProducts as $item)
                    <tr>
                        <td><img src="{{ asset('uploads/custom-images2/' . $item->product->thumb_image) }}" alt=""
                                height="100"></td>
                        ...
                        @if ($item->product->product_type == '3')
                            <td class="text-center">
                                ...
                                <button style="width: 50%;padding: 5px !important;"
...
<!--                                    @empty-->
    ...
    @foreach ($order->orderProducts as $item)
        <div class="modal fade" id="read_more_{{ $item->product->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
