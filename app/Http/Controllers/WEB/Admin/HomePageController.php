...
class HomePageController extends Controller
{
    ...
    public function featuredCategory()
    {
        ...
        return view("admin.featured_category",
            compact("featuredCategories", "categories", "banner")
        );
    }
    public function menuCategory()
    {
        $menuCategories = MenuCats::with("category")->get();
        $categories = Category::where("status", 1)->get();

        return view("admin.cats.menu_cats",
            compact("menuCategories", "categories")
        );
    }
    ...
    public function destroymenuCategory($id)
    {
        ...
        $category = MenuCats::where("id", $id)->first();
        $category->delete();
